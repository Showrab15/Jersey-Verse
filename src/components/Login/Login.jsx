      ...
      <div className="hero-content mt-8 p-0">
        <div className="card lg:w-[1200px] p-8 flex-shrink-0 w-full max-w-sm outline outline-offset-2 outline-pink-500  bg-base-100">
          <form onSubmit={handleSignIn}>
            ...
            <div className="w-full">
              ...
              <div className="form-control ">
                <p className="mb-2 font-semibold text-xl text-green-600">
                  {success}
                </p>
                <p className="mb-2 font-semibold text-xl text-red-600">
                  {error}
                </p>
          ...
          <div className="flex items-center">
            <hr className="short-line" /> <p className="font-semibold">or</p>{" "}
            <hr className="short-line" />
          </div>
          <button onClick={handleGoogleSignIn} className="button mt-2">
            <FaGoogle className="mr-1 text-primary "></FaGoogle>Login With
            Google
          </button>
        </div>
      </div>
