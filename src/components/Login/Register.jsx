    ...
    <div className="my-container">
      <div className="hero-content  mt-8 p-0 ">
        <form
          ...
          className="card lg:w-[1200px] p-8 flex-shrink-0 w-full max-w-sm outline outline-offset-2 outline-pink-500  bg-base-100"
        >
          <h1 className="title">Create An Account In Jersey Verse </h1>
          ...
          <div className="w-full">
            ...
            <div className="form-control mt-6">
              ...
              <p className="mt-2 font-semibold text-xl text-green-600">
                {success}
              </p>
